   ...
   <!-- Fixed navbar -->
   <div class="navbar navbar-default navbar-fixed-top" ng-controller="ControllerTop" role="navigation">
     <div class="container">
...
<!--           <li ng-class="{ active: toggler.showLogin }" ng-if="!user.isLogged">
          ...
          <ul class="navbar-form navbar-left" role="search">
            <select class="form-control" data-ng-options="l.name for l in langs" data-ng-model="selectedLang"></select>
          </ul>
