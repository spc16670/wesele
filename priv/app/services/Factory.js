...
var whaleFactories = angular.module('whale.Factories',[]);

whaleFactories.factory('FactoryBullet', ['$q','$timeout','$rootScope', 
  ...
  var port = document.getElementById('http_port').textContent;
  var scheme = "ws";
  if (port === "") {
    scheme = "wss";
    port = document.getElementById('https_port').textContent;
  } 
  var clientTimeout = parseInt(clientTimeout);
  var url = scheme + '://' + hostname.textContent  + ':' + port + '/bullet/' + sid.textContent;
...
whaleFactories.factory('FactoryAuth', ['FactoryBullet','FactoryStorage'
...
whaleFactories.factory('FactoryPartials', ['FactoryRequest','FactoryBullet',
...
whaleFactories.factory('FactoryStorage',['$window',function($window) {
  var StorageService = {};
...
whaleFactories.factory('FactoryRequest', ['FactoryAuth',
...
whaleFactories.factory('FactoryAlert', [function() {
  return {
